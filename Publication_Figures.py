...
Veh_ax_S1_plt.legend(["mean", f"$3\sigma$", "true"], labelspacing=.07, handlelength=1.0, loc='lower right', fontsize=5)
...
EMPS_ax_S1_plt.plot(EMPS_dq_plot, EMPS_dq_plot*203.5 + 20.39*np.sign(EMPS_dq_plot) + 3.16, color='g', linestyle=':')
EMPS_ax_S1_plt.legend(["mean", f"$3\sigma$", "linear"], labelspacing=.07, handlelength=1.0, loc='lower right', fontsize=5)
